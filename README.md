...
## 一、项目简介
`wan-resume` 是一个使用 React 19 和 Vite 7 构建的现代化个人在线简历项目。它提供了简洁美观的界面，支持从 Markdown 文件动态加载简历内容，具有高度的可定制性，同时提供了良好的打印体验。用户可以通过修改配置文件轻松定制简历的各个方面，使用熟悉的 Markdown 语法撰写详细的简历信息。
